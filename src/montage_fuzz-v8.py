...
V8_FIRST = {'lines': {'percent': '40.4', 'count': '257122', 'all': '636765'}, 
             'functions': {'percent': '35.5', 'count': '153595', 'all': '432185'}}
COVERAGE = {}
...
def main():   
    ...
    conf = Config(MAIN_PATH+'js_generator/conf-v8.json',MAIN_PATH)
    try:
        fuzzer = Fuzzer(conf)
        try:
            fuzzer.fuzz()
