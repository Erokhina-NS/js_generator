...
CK_FIRST = {'lines': {'percent': '63.6', 'count': '171815', 'all': '270360'}, 
             'functions': {'percent': '35.2', 'count': '36619', 'all': '104156'}}
...
def main():   
    ...
    conf = Config(MAIN_PATH+'js_generator/conf-jsc.json',MAIN_PATH)
    try:
        fuzzer = Fuzzer(conf)
        try:
            fuzzer.fuzz()
